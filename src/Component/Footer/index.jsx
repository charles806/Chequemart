        ...
        <>
            <footer className='py-6 bg-[#fafafa]'>
                <div className="my-container">
                    ...
                    {/* Icons strip — 2-col grid on mobile, 3-col on sm, row on lg */}
                    <div className="grid grid-cols-2 gap-6 py-6 sm:grid-cols-3 lg:flex lg:flex-row lg:justify-around lg:items-start lg:py-8 lg:px-5 text-center">
                        <div className="flex items-center justify-center flex-col group">
                            ...
                            <p className="text-[12px] font-medium">For all Orders</p>
                        </div>
                        <div className="flex items-center justify-center flex-col group">
                        ...
                        <div className="flex items-center justify-center flex-col group col-span-2 sm:col-span-1">
                    ...
                    <div className="footer flex px-3 lg:px-0 flex-col lg:flex-row py-8">
                        <div className="part1 w-full lg:w-[25%] border-r border-[rgba(0,0,0,0.1)]">
                            ...
                            <p className="text-[13px] font-normal pb-4">{"Chequemart - ecommerce salesive"}</p>
                        ...
                        <div className="part2 w-full lg:w-[40%] flex pl-0 lg:pl-8 mt-5 lg:mt-0">
                            <div className="part2_col1 w-[50%]">
                                ...
                                <ul className="list">
                                    ...
                                    <li className='list-none text-[14px] w-full mb-2'><Link to="/products" className='link'>New Products</Link></li>
                                    <li className='list-none text-[14px] w-full mb-2'><Link to="/products" className='link'>Best Sales</Link></li>
                            ...
                            <div className="part2_col2 w-[50%]">
                                ...
                                <ul className="list">
                                    <li className="list-none text-[14px] w-full mb-2"><Link to="/about" className='link'>About Us</Link></li>
                                    <li className="list-none text-[14px] w-full mb-2"><Link to="/terms" className='link'>Terms & Conditions</Link></li>
                                    <li className="list-none text-[14px] w-full mb-2"><Link to="/privacy" className='link'>Privacy Policy</Link></li>
                                    <li className="list-none text-[14px] w-full mb-2"><Link to="/payment" className='link'>Payment Information</Link></li>
                                    <li className="list-none text-[14px] w-full mb-2"><Link to="/login" className='link'>Login</Link></li>
                                </ul>
                            </div>
                        </div>

                        <div className="part3 w-full lg:w-[35%] flex pl-0 lg:pl-8 flex-col pr-8 mt-5 lg:mt-0">
                            <h2 className="text-[18px] font-semibold mb-2 lg:mb-4">Subscribe to our newsletter</h2>
                            ...
                            <form action="" className="mt-5">
                                ...
                                <FormControlLabel
                                    control={
                                        <Checkbox sx={{ color: "#000", "&.Mui-checked": { color: "#ff6b26" } }} />
                                    }
                                    label={<span style={{ fontSize: "13px" }}>I agree to the terms and conditions and the privacy policy</span>}
                                />
                            </form>
                        </div>
                    </div>
            ...
            <div className="bottomStrip border-t border-[rgba(0,0,0,0.1)] pt-3 pb-25 lg:pb-3 bg-white">
                <div className="my-container flex items-center justify-between flex-col lg:flex-row gap-4 lg:gap-0">
                    ...
                    <p className="text-[13px] text-center mb-0">© 2026 - Chequemart</p>
