        ...
        <aside className="sidebar py-3  lg:py-5 static lg:sticky top-32.5 z-50 pr-0 lg:pr-5">
            <div className="sidebarScroll max-h-[60vh] lg:max-h-max  lg:overflow-visible overflow-auto w-full">
                <div className="box">
                    ...
                    >
                        <FormControlLabel control={<Checkbox className='fill-[#ff5252]! text-[#ff5252]!' />} label="Fashion" className='text-black!' />
                        <FormControlLabel control={<Checkbox className='fill-[#ff5252]! text-[#ff5252]!' />} label="Electronics" className='text-black!' />
                        <FormControlLabel control={<Checkbox className='fill-[#ff5252]! text-[#ff5252]!' />} label="Bags" className='text-black!' />
                        <FormControlLabel control={<Checkbox className='fill-[#ff5252]! text-[#ff5252]!' />} label="Footware" className='text-black!' />
                        <FormControlLabel control={<Checkbox className='fill-[#ff5252]! text-[#ff5252]!' />} label="Jewellery" className='text-black!' />
                        <FormControlLabel control={<Checkbox className='fill-[#ff5252]! text-[#ff5252]!' />} label="Wellness" className='text-black!' />
                        <FormControlLabel control={<Checkbox className='fill-[#ff5252]! text-[#ff5252]!' />} label="Beauty" className='text-black!' />
                        <FormControlLabel control={<Checkbox className='fill-[#ff5252]! text-[#ff5252]!' />} label="Games" className='text-black!' />
                    </div>
